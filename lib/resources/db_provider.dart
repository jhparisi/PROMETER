...
class DBProvider{
  ...
  Future<List<PlayPauseTracking>> getPlayAndPause() async{
    ...
    if(maps.length>0){
      ...
      return maps.map<PlayPauseTracking>((item) => new PlayPauseTracking.fromDb(item)).toList();
    }
  ...
  Future<List<TrackingData>> getTrackingAll() async{
    ...
    if(maps.length>0){
      print(maps.map<TrackingData>((item) => new TrackingData.fromDb(item)).toList());
      return maps.map<TrackingData>((item) => new TrackingData.fromDb(item)).toList();
    }
  ...
  Future<List<WorkingDay>> getWorkingDay() async{
    ...
    if(maps.length>0){
      print(maps.map<WorkingDay>((item) => new WorkingDay.fromDb(item)).toList());
      return maps.map<WorkingDay>((item) => new WorkingDay.fromDb(item)).toList();
    }
