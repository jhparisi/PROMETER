                  ...
                  Center(
                    child: Column(
                      children: <Widget>[
                        ...
                        Text('Tu posición actual es:', style: TextStyle(fontSize: 10.0),),
                              ...
                              child: Column(
                                children: <Widget>[
                                  MaterialButton(
                                    onPressed: (){
                                      if(acompanante==0){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>PTRepostar()));
                                      }                                      
                                    },
                                    minWidth: 120.0,
                                    height: 120.0,                                    
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                        Icon(Icons.local_gas_station, size: 100.0, color: getColor("green")),
                                        Text("Repostar", style: TextStyle(color: getColor("black")))
                                      ],
                                    )
                                  )   
                                ],
                              ...
                              child: Column(
                                children: <Widget>[
                                  MaterialButton(
                                    onPressed: (){
                                      if(acompanante==0){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>PTIniciarRuta()));
                                      }
                                      else{
                                        final data = PlayPauseTracking(trackingPLay: 0, userId: userId, dateBeginning: fecha);
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                        Icon(Icons.swap_calls, size: 100.0, color: Colors.blueAccent),
                                        Text("Iniciar Ruta")
                                      ],
                                    )
                                  )   
