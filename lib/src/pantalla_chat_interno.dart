...
class _PTChatInternoState extends State<PTChatInterno> with TickerProviderStateMixin {
    ...
    child: new Container(
     ...
     new Container(
       child: new IconButton(
         ...
         onPressed: _isTyped ?
          () => _handledSubmit(_textController.text, DateTime.now().toString()) :
          null,
       ),
     )
     ]),
  ...
  return new SizeTransition(
    ...
    child: Card(
      ...
      title: new Row(
        ...
        children: <Widget>[
          new Text(name, 
          style: new TextStyle(fontWeight: FontWeight.bold, fontSize: 10.0,color: Colors.blue),
          ),
          new Text(
            tiempo,
